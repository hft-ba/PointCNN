...
test_files="../../data/modelnet/end_test_files.txt"
...
CUDA_VISIBLE_DEVICES=$gpu python3 ../train_val_test_cls.py -t $train_files -v $val_files -j $test_files -s $models_folder -m pointcnn_cls -x $setting > $models_folder/pointcnn_cls_$setting.txt 2>&1 &
